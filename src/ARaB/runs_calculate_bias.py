...
docs_bias_paths = {'tc':"./data/ARaB/msmarco_passage_docs_bias_tc.pkl",
                   'tf':"./data/ARaB/msmarco_passage_docs_bias_tf.pkl",
                   'bool':"./data/ARaB/msmarco_passage_docs_bias_bool.pkl",
                   }
...
experiments = {'bert-mini': 'results/bias_inferences/ecir_neutrals/inference_bert-mini.trec',
               'betr-mini_bias': 'results/bias_inferences/ecir_neutrals/inference_bert-mini_bias.trec',
               'bert-tiny': 'results/bias_inferences/ecir_neutrals/inference_bert-tiny.trec',
               'bert-tiny_bias': 'results/bias_inferences/ecir_neutrals/inference_bert-tiny_bias.trec',
               'electra-small': 'results/bias_inferences/ecir_neutrals/inference_electra-small.trec',
               'electra-small_bias': 'results/bias_inferences/ecir_neutrals/inference_electra-small_bias.trec',
               'distilroberta': 'results/bias_inferences/ecir_neutrals/inference_distilroberta.trec',
               'distilroberta_bias': 'results/bias_inferences/ecir_neutrals/inference_distilroberta_bias.trec',
               }
